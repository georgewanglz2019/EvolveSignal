...
def parse_args() -> argparse.Namespace:
    ...
    #                     default='examples/function_minimization/initial_program.py')
    # parser.add_argument(
    #     "--evaluation_file", help="Path to the evaluation file containing an 'evaluate' function",
    #     default='examples/function_minimization/evaluator.py'
    # )
    # parser.add_argument("--config", "-c", help="Path to configuration file (YAML)", default=None)

    # traffic signal control
    parser.add_argument("--initial_program", help="Path to the initial program file",
                        default='examples/traffic_signal_control/initial_program.py')
    parser.add_argument(
        "--evaluation_file", help="Path to the evaluation file containing an 'evaluate' function",
        default='examples/traffic_signal_control/evaluator.py'
    )

    parser.add_argument("--config", "-c", help="Path to configuration file (YAML)", default='examples/traffic_signal_control/config.yaml')

    parser.add_argument("--output", "-o", help="Output directory for results", default=None)

    parser.add_argument(
        "--iterations", "-i", help="Maximum number of iterations", type=int, default=600
    )
    ...
    # parser.add_argument("--api-base", help="Base URL for the LLM API", default='https://api.deepseek.com')
    #
    # parser.add_argument("--primary-model", help="Primary LLM model name", default='deepseek-chat')
    #
    # parser.add_argument("--secondary-model", help="Secondary LLM model name", default='deepseek-reasoner')
