...
# Load repo-root .env (parent of openevolve package)
...
class EvaluatorConfig:
    ...
    # General settings
    timeout: int = 500  # Maximum evaluation time in seconds
    max_retries: int = 3
...
def load_config(config_path: Optional[Union[str, Path]] = None) -> Config:
    ...
    if config_path and os.path.exists(config_path):
        ...
        api_base = 'https://api.deepseek.com'  # os.environ.get("OPENAI_API_BASE", "https://api.openai.com/v1")
